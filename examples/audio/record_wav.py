#Ghi am 4 giay, sau do luu noi dung vao the nho
#Thay doi ten file ghi am tai dong so 30
...
#import time
# init audio
recorder = audio.Audio(path="/sd/record2.wav", is_create=True, samplerate=sample_rate)
